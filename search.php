...
<body>
<h1>Search here!</h1>
<p>Fill in your company name or  name or email address, then click <strong>Search
</strong> to search.</p>
...
<?php
 ...
 die(var_dump($e));
    ...
    // Retrieve data
    $sql_select = "SELECT * FROM registration_tbl WHERE name='$name' OR company_name='$company_name' OR email='$email'";
